...
class Hackathon(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('hackathon_detail', kwargs={'slug': self.slug})

    def __str__(self):
        return self.title
    
def create_hackathon_slug(sender, instance, *args, **kwargs):
    if not instance.slug:
        instance.slug = slugify(instance.title)

pre_save.connect(create_hackathon_slug, sender=Hackathon)
