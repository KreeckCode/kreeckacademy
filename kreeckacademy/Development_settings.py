...
if DEBUG:
    ALLOWED_HOSTS = ['*','kreeckacademy.s3.amazonaws.com']
else:
    ALLOWED_HOSTS = ['*','kreeckacademy.s3.amazonaws.com','https://academykreeck.azurewebsites.net','http://academykreeck.azurewebsites.net','https://academy.kreeck.com','http://academy.kreeck.com']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'django.template.context_procompileSMScessors.debug',
...
# Set the URL to serve media files from S3
