    ...
    def form_valid(self, form, **kwargs):
        ...
        with transaction.atomic():
            ...
            if form.is_valid():
                ...
                #students_emails = course.students.values_list('student__email', flat=True)
                quiz_title = form.instance.title
                subject = "New Quiz Created for Course"
                template = 'emails/new-quiz.html'
                context = {
                    'course': course,
